...
class FortiAnalyzer(object):
    ...
    def login(self):
        """Logs in to the FortiAnalyzer API.
    ...
    def logout(self):
        """Logs out of the FortiAnalyzer API.
    ...
    def login_check(self):
        ...
        if self.api.session:
            ...
            # Use the sys_status endpoint as a test to see if our session is valid in FortiAnalyzer
            data = {
                "method": "get",
                "params": [
                    {
            ...
            if sys_status.status_code == 200:
                ...
                # If the FortiAnalyzer request is unsuccessful, log in again.
    ...
    def post(self, method: str, params: dict):
        """Sends a POST request to the FortiAnalyzer API.
